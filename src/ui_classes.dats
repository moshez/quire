...
(* "visibilitychange" = 16 chars *)
implement evt_visibilitychange() = let
  ...
  val b = ward_text_putc(b, 7, char2int1('i'))
  val b = ward_text_putc(b, 8, char2int1('t'))
  val b = ward_text_putc(b, 9, char2int1('y'))
  val b = ward_text_putc(b, 10, char2int1('c'))
  val b = ward_text_putc(b, 11, char2int1('h'))
  val b = ward_text_putc(b, 12, char2int1('a'))
  val b = ward_text_putc(b, 13, char2int1('n'))
  val b = ward_text_putc(b, 14, char2int1('g'))
  val b = ward_text_putc(b, 15, char2int1('e'))
in ward_text_done(b) end

(* "settings-btn" = 12 chars *)
implement cls_settings_btn() = let
  val b = ward_text_build(12)
  ...
  val b = ward_text_putc(b, 7, char2int1('s'))
  val b = ward_text_putc(b, 8, char2int1('-'))
...
(* "search-panel" = 12 chars *)
implement cls_search_panel() = let
  val b = ward_text_build(12)
  val b = ward_text_putc(b, 0, char2int1('s'))
  val b = ward_text_putc(b, 1, char2int1('e'))
  val b = ward_text_putc(b, 2, char2int1('a'))
  ...
  val b = ward_text_putc(b, 5, char2int1('h'))
  val b = ward_text_putc(b, 6, 45) (* '-' *)
  val b = ward_text_putc(b, 7, char2int1('p'))
