...
#define DARK_THEME_CSS_LEN 356
#define SEPIA_THEME_CSS_LEN 336
 ...
 *      html .stg-overlay{background:rgba(0,0,0,.7)}
 *      html .stg-row button{background:#333;color: #ccc;border-color:#555}
 *      html .stg-lbl{color: #939393}
 *      .reader-nav{background:#222}.reader-bottom{background:#222} *)
fn _fill_dark_theme {l:agz}{n:int | n >= 356}
  ...
  val () = _w4(arr, alen, 156, 1836345469)
  val () = _w4(arr, alen, 160, 1932402796)
  val () = _w4(arr, alen, 164, 1865246580)
  val () = _w4(arr, alen, 168, 1819436406)
  val () = _w4(arr, alen, 172, 1652259169)
  val () = _w4(arr, alen, 176, 1735091041)
  val () = _w4(arr, alen, 180, 1853190002)
  val () = _w4(arr, alen, 184, 1735539300)
  val () = _w4(arr, alen, 188, 807952738)
  val () = _w4(arr, alen, 192, 808202284)
  val () = _w4(arr, alen, 196, 691482156)
  val () = _w4(arr, alen, 200, 1836345469)
  val () = _w4(arr, alen, 204, 1932402796)
  val () = _w4(arr, alen, 208, 1915578228)
  val () = _w4(arr, alen, 212, 1646294895)
  val () = _w4(arr, alen, 216, 1869902965)
  val () = _w4(arr, alen, 220, 1633844078)
  val () = _w4(arr, alen, 224, 1919380323)
  val () = _w4(arr, alen, 228, 1684960623)
  val () = _w4(arr, alen, 232, 858989370)
  val () = _w4(arr, alen, 236, 1868774195)
  val () = _w4(arr, alen, 240, 980578156)
  val () = _w4(arr, alen, 244, 1667441440)
  val () = _w4(arr, alen, 248, 1868708707)
  val () = _w4(arr, alen, 252, 1919247474)
  val () = _w4(arr, alen, 256, 1819239213)
  val () = _w4(arr, alen, 260, 591032943)
  val () = _w4(arr, alen, 264, 2100639029)
  val () = _w4(arr, alen, 268, 1819112552)
  val () = _w4(arr, alen, 272, 1953705504)
  val () = _w4(arr, alen, 276, 1651256679)
  val () = _w4(arr, alen, 280, 1868790636)
  val () = _w4(arr, alen, 284, 980578156)
  val () = _w4(arr, alen, 288, 859382560)
  val () = _w4(arr, alen, 292, 859386681)
  val () = _w4(arr, alen, 296, 1701981821)
  val () = _w4(arr, alen, 300, 1919247457)
  val () = _w4(arr, alen, 304, 1986096685)
  val () = _w4(arr, alen, 308, 1667326587)
  val () = _w4(arr, alen, 312, 1869768555)
  val () = _w4(arr, alen, 316, 979660405)
  val () = _w4(arr, alen, 320, 842150435)
  val () = _w4(arr, alen, 324, 1701981821)
  val () = _w4(arr, alen, 328, 1919247457)
  val () = _w4(arr, alen, 332, 1953456685)
  val () = _w4(arr, alen, 336, 2070769524)
  val () = _w4(arr, alen, 340, 1801675106)
  val () = _w4(arr, alen, 344, 1970238055)
  val () = _w4(arr, alen, 348, 591029358)
  val () = _w4(arr, alen, 352, 2100441650)
in end
 ...
 *      html .stg-row button{background:#e8dcc8;color: #3a3020;border-color:#c0b090}
 *      html .stg-lbl{color: #3a3020}
 *      .reader-nav{background:#f0e6d2}.reader-bottom{background:#f0e6d2} *)
fn _fill_sepia_theme {l:agz}{n:int | n >= 336}
  (arr: !ward_arr(byte, l, n), alen: int n): void = let
  val () = _w4(arr, alen, 0, 1819112552)
  val () = _w4(arr, alen, 4, 1685021228)
  val () = _w4(arr, alen, 8, 1633844089)
  ...
  val () = _w4(arr, alen, 164, 1953004848)
  val () = _w4(arr, alen, 168, 773876845)
  val () = _w4(arr, alen, 172, 761754739)
  val () = _w4(arr, alen, 176, 544698226)
  val () = _w4(arr, alen, 180, 1953789282)
  val () = _w4(arr, alen, 184, 1652256367)
  val () = _w4(arr, alen, 188, 1735091041)
  val () = _w4(arr, alen, 192, 1853190002)
  val () = _w4(arr, alen, 196, 1696807524)
  val () = _w4(arr, alen, 200, 1667458104)
  val () = _w4(arr, alen, 204, 1868774200)
  val () = _w4(arr, alen, 208, 980578156)
  val () = _w4(arr, alen, 212, 1630741280)
  val () = _w4(arr, alen, 216, 808595507)
  val () = _w4(arr, alen, 220, 1919902267)
  val () = _w4(arr, alen, 224, 762471780)
  val () = _w4(arr, alen, 228, 1869377379)
  val () = _w4(arr, alen, 232, 1663253106)
  val () = _w4(arr, alen, 236, 959472176)
  val () = _w4(arr, alen, 240, 1953004848)
  val () = _w4(arr, alen, 244, 773876845)
  val () = _w4(arr, alen, 248, 761754739)
  val () = _w4(arr, alen, 252, 2070700652)
  val () = _w4(arr, alen, 256, 1869377379)
  val () = _w4(arr, alen, 260, 589314674)
  val () = _w4(arr, alen, 264, 808673587)
  val () = _w4(arr, alen, 268, 779956274)
  val () = _w4(arr, alen, 272, 1684104562)
  val () = _w4(arr, alen, 276, 1848472165)
  val () = _w4(arr, alen, 280, 1652258401)
  val () = _w4(arr, alen, 284, 1735091041)
  val () = _w4(arr, alen, 288, 1853190002)
  val () = _w4(arr, alen, 292, 1713584740)
  val () = _w4(arr, alen, 296, 1681286448)
  val () = _w4(arr, alen, 300, 1915649330)
  val () = _w4(arr, alen, 304, 1701077349)
  val () = _w4(arr, alen, 308, 1868705138)
  val () = _w4(arr, alen, 312, 1836020852)
  val () = _w4(arr, alen, 316, 1667326587)
  val () = _w4(arr, alen, 320, 1869768555)
  val () = _w4(arr, alen, 324, 979660405)
  val () = _w4(arr, alen, 328, 1697670691)
  val () = _w4(arr, alen, 332, 2100454454)
in end
...
in
  if gt_int_int(style_id, 0) then
    ...
    in end
      ...
      (* Sepia theme *)
      val arr = ward_arr_alloc<byte>(SEPIA_THEME_CSS_LEN)
      val () = _fill_sepia_theme(arr, SEPIA_THEME_CSS_LEN)
      val @(frozen, borrow) = ward_arr_freeze<byte>(arr)
      val dom = ward_dom_init()
      val s = ward_dom_stream_begin(dom)
