...
fn fill_css_content {l:agz}{n:pos}
  ...
  val () = _w4(arr, alen, 1065, 1852793645)
  val () = _w4(arr, alen, 1069, 1852399988)
  val () = _w4(arr, alen, 1073, 1746956901)
  val () = _w4(arr, alen, 1077, 1663970353)
  val () = _w4(arr, alen, 1081, 1953522024)
  val () = _w4(arr, alen, 1085, 1663922789)
  val () = _w4(arr, alen, 1089, 1635020399)
  val () = _w4(arr, alen, 1093, 1919250025)
  val () = _w4(arr, alen, 1097, 741500960)
  val () = _w4(arr, alen, 1101, 1634231086)
  val () = _w4(arr, alen, 1105, 1919251568)
  val () = _w4(arr, alen, 1109, 1852793645)
  val () = _w4(arr, alen, 1113, 1852399988)
  val () = _w4(arr, alen, 1117, 1746956901)
  val () = _w4(arr, alen, 1121, 1634564915)
  val () = _w4(arr, alen, 1125, 1852401522)
  val () = _w4(arr, alen, 1129, 1886352429)
  val () = _w4(arr, alen, 1133, 892219706)
  val () = _w4(arr, alen, 1137, 1832611173)
  val () = _w4(arr, alen, 1141, 1768387169)
  val () = _w4(arr, alen, 1145, 1868705134)
  val () = _w4(arr, alen, 1149, 1836020852)
  val () = _w4(arr, alen, 1153, 1697984058)
  val () = _w4(arr, alen, 1157, 1768700781)
  val () = _w4(arr, alen, 1161, 1747805550)
  val () = _w4(arr, alen, 1165, 1751607653)
  val () = _w4(arr, alen, 1169, 774978164)
  (* .chapter-container p *)
  val () = _w4(arr, alen, 1173, 1663991091)
  val () = _w4(arr, alen, 1177, 1953522024)
  val () = _w4(arr, alen, 1181, 1663922789)
  val () = _w4(arr, alen, 1185, 1635020399)
  val () = _w4(arr, alen, 1189, 1919250025)
  val () = _w4(arr, alen, 1193, 1836806176)
  val () = _w4(arr, alen, 1197, 1768387169)
  val () = _w4(arr, alen, 1201, 540031598)
  val () = _w4(arr, alen, 1205, 942546992)
  val () = _w4(arr, alen, 1209, 1950051685)
  val () = _w4(arr, alen, 1213, 762607717)
  val () = _w4(arr, alen, 1217, 1734962273)
  val () = _w4(arr, alen, 1221, 1969896046)
  val () = _w4(arr, alen, 1225, 1718187123)
  (* .chapter-container blockquote *)
  val () = _w4(arr, alen, 1229, 1663991161)
  val () = _w4(arr, alen, 1233, 1953522024)
  val () = _w4(arr, alen, 1237, 1663922789)
  val () = _w4(arr, alen, 1241, 1635020399)
  val () = _w4(arr, alen, 1245, 1919250025)
  val () = _w4(arr, alen, 1249, 1869373984)
  val () = _w4(arr, alen, 1253, 1970367331)
  val () = _w4(arr, alen, 1257, 2070246511)
  val () = _w4(arr, alen, 1261, 1735549293)
  val () = _w4(arr, alen, 1265, 825912937)
  val () = _w4(arr, alen, 1269, 840985957)
  val () = _w4(arr, alen, 1273, 1882942821)
  val () = _w4(arr, alen, 1277, 1768186977)
  val () = _w4(arr, alen, 1281, 1814914926)
  val () = _w4(arr, alen, 1285, 980706917)
  val () = _w4(arr, alen, 1289, 997025073)
  val () = _w4(arr, alen, 1293, 1685221218)
  val () = _w4(arr, alen, 1297, 1814917733)
  val () = _w4(arr, alen, 1301, 980706917)
  val () = _w4(arr, alen, 1305, 544763955)
  val () = _w4(arr, alen, 1309, 1768714099)
  val () = _w4(arr, alen, 1313, 1663246436)
  val () = _w4(arr, alen, 1317, 1664836451)
  val () = _w4(arr, alen, 1321, 1919904879)
  val () = _w4(arr, alen, 1325, 892674874)
  (* .chapter-container pre *)
  val () = _w4(arr, alen, 1329, 1663991093)
  val () = _w4(arr, alen, 1333, 1953522024)
  val () = _w4(arr, alen, 1337, 1663922789)
  val () = _w4(arr, alen, 1341, 1635020399)
  val () = _w4(arr, alen, 1345, 1919250025)
  val () = _w4(arr, alen, 1349, 1701998624)
  val () = _w4(arr, alen, 1353, 1667326587)
  val () = _w4(arr, alen, 1357, 1869768555)
  val () = _w4(arr, alen, 1361, 979660405)
  val () = _w4(arr, alen, 1365, 1714710051)
  val () = _w4(arr, alen, 1369, 993289780)
  val () = _w4(arr, alen, 1373, 1684300144)
  val () = _w4(arr, alen, 1377, 979857001)
  val () = _w4(arr, alen, 1381, 1835350062)
  val () = _w4(arr, alen, 1385, 1919902267)
  val () = _w4(arr, alen, 1389, 762471780)
  val () = _w4(arr, alen, 1393, 1768186226)
  val () = _w4(arr, alen, 1397, 876245877)
  val () = _w4(arr, alen, 1401, 1866168432)
  val () = _w4(arr, alen, 1405, 1718773110)
  val () = _w4(arr, alen, 1409, 762802028)
  val () = _w4(arr, alen, 1413, 1969306232)
  val () = _w4(arr, alen, 1417, 1715171188)
  val () = _w4(arr, alen, 1421, 762605167)
  val () = _w4(arr, alen, 1425, 1702521203)
  val () = _w4(arr, alen, 1429, 1698246202)
  (* .chapter-container code *)
  val () = _w4(arr, alen, 1433, 1663991149)
  val () = _w4(arr, alen, 1437, 1953522024)
  val () = _w4(arr, alen, 1441, 1663922789)
  val () = _w4(arr, alen, 1445, 1635020399)
  val () = _w4(arr, alen, 1449, 1919250025)
  val () = _w4(arr, alen, 1453, 1685021472)
  val () = _w4(arr, alen, 1457, 1633844069)
  val () = _w4(arr, alen, 1461, 1919380323)
  val () = _w4(arr, alen, 1465, 1684960623)
  val () = _w4(arr, alen, 1469, 879108922)
  val () = _w4(arr, alen, 1473, 879113318)
  val () = _w4(arr, alen, 1477, 1684107323)
  val () = _w4(arr, alen, 1481, 1735289188)
  val () = _w4(arr, alen, 1485, 1697721914)
  val () = _w4(arr, alen, 1489, 858660973)
  val () = _w4(arr, alen, 1493, 1648061797)
  val () = _w4(arr, alen, 1497, 1701081711)
  val () = _w4(arr, alen, 1501, 1634872690)
  val () = _w4(arr, alen, 1505, 1937074532)
  val () = _w4(arr, alen, 1509, 2020618810)
  val () = _w4(arr, alen, 1513, 1852794427)
  val () = _w4(arr, alen, 1517, 1769155956)
  val () = _w4(arr, alen, 1521, 775579002)
  val () = _w4(arr, alen, 1525, 2104321337)
  (* .chapter-container img *)
  val () = _w4(arr, alen, 1529, 1634231086)
  val () = _w4(arr, alen, 1533, 1919251568)
  val () = _w4(arr, alen, 1537, 1852793645)
  val () = _w4(arr, alen, 1541, 1852399988)
  val () = _w4(arr, alen, 1545, 1763734117)
  val () = _w4(arr, alen, 1549, 1836803949)
  val () = _w4(arr, alen, 1553, 1999468641)
  val () = _w4(arr, alen, 1557, 1752458345)
  val () = _w4(arr, alen, 1561, 808464698)
  val () = _w4(arr, alen, 1565, 1701329701)
  val () = _w4(arr, alen, 1569, 1952999273)
  val () = _w4(arr, alen, 1573, 1953849658)
  (* .chapter-container a *)
  val () = _w4(arr, alen, 1577, 1663991151)
  val () = _w4(arr, alen, 1581, 1953522024)
  val () = _w4(arr, alen, 1585, 1663922789)
  val () = _w4(arr, alen, 1589, 1635020399)
  val () = _w4(arr, alen, 1593, 1919250025)
  val () = _w4(arr, alen, 1597, 1669030176)
  val () = _w4(arr, alen, 1601, 1919904879)
  val () = _w4(arr, alen, 1605, 1630806842)
  val () = _w4(arr, alen, 1609, 959800119)
  (* .chapter-container table *)
  val () = _w4(arr, alen, 1613, 1751330429)
  val () = _w4(arr, alen, 1617, 1702129761)
  val () = _w4(arr, alen, 1621, 1868770674)
  val () = _w4(arr, alen, 1625, 1767994478)
  val () = _w4(arr, alen, 1629, 544367982)
  val () = _w4(arr, alen, 1633, 1818386804)
  val () = _w4(arr, alen, 1637, 1868725093)
  val () = _w4(arr, alen, 1641, 1919247474)
  val () = _w4(arr, alen, 1645, 1819239213)
  val () = _w4(arr, alen, 1649, 1936744812)
  val () = _w4(arr, alen, 1653, 1868773989)
  val () = _w4(arr, alen, 1657, 1885432940)
  val () = _w4(arr, alen, 1661, 1832609139)
  val () = _w4(arr, alen, 1665, 1768387169)
  val () = _w4(arr, alen, 1669, 1697725038)
  val () = _w4(arr, alen, 1673, 2100306029)
  (* .chapter-container td,.chapter-container th *)
  val () = _w4(arr, alen, 1677, 1634231086)
  val () = _w4(arr, alen, 1681, 1919251568)
  val () = _w4(arr, alen, 1685, 1852793645)
  val () = _w4(arr, alen, 1689, 1852399988)
  val () = _w4(arr, alen, 1693, 1948283493)
  val () = _w4(arr, alen, 1697, 1663970404)
  val () = _w4(arr, alen, 1701, 1953522024)
  val () = _w4(arr, alen, 1705, 1663922789)
  val () = _w4(arr, alen, 1709, 1635020399)
  val () = _w4(arr, alen, 1713, 1919250025)
  val () = _w4(arr, alen, 1717, 2070443040)
  val () = _w4(arr, alen, 1721, 1685221218)
  val () = _w4(arr, alen, 1725, 825913957)
  val () = _w4(arr, alen, 1729, 1931507824)
  val () = _w4(arr, alen, 1733, 1684630639)
  val () = _w4(arr, alen, 1737, 1684284192)
  val () = _w4(arr, alen, 1741, 1634745188)
  val () = _w4(arr, alen, 1745, 1852400740)
  val () = _w4(arr, alen, 1749, 875444839)
  val () = _w4(arr, alen, 1753, 773877093)
  val () = _w4(arr, alen, 1757, 2104321336)
in end

fn fill_css_import {l:agz}{n:pos}
  (arr: !ward_arr(byte, l, n), alen: int n): void = let
  (* .importing *)
  val () = _w4(arr, alen, 1761, 1886218542)
  val () = _w4(arr, alen, 1765, 1769239151)
  val () = _w4(arr, alen, 1769, 1685809006)
  val () = _w4(arr, alen, 1773, 1819308905)
  val () = _w4(arr, alen, 1777, 1765439841)
  val () = _w4(arr, alen, 1781, 1852402798)
  val () = _w4(arr, alen, 1785, 1818373477)
  val () = _w4(arr, alen, 1789, 996893551)
  val () = _w4(arr, alen, 1793, 1684300144)
  val () = _w4(arr, alen, 1797, 979857001)
  val () = _w4(arr, alen, 1801, 1701983534)
  val () = _w4(arr, alen, 1805, 774971501)
  val () = _w4(arr, alen, 1809, 1835364914)
  val () = _w4(arr, alen, 1813, 1918987579)
  val () = _w4(arr, alen, 1817, 980314471)
  val () = _w4(arr, alen, 1821, 1835364913)
  val () = _w4(arr, alen, 1825, 1667326523)
  val () = _w4(arr, alen, 1829, 1869768555)
  val () = _w4(arr, alen, 1833, 979660405)
  val () = _w4(arr, alen, 1837, 929117219)
  val () = _w4(arr, alen, 1841, 993604963)
  val () = _w4(arr, alen, 1845, 1869377379)
  val () = _w4(arr, alen, 1849, 1713584754)
  val () = _w4(arr, alen, 1853, 1648060006)
  val () = _w4(arr, alen, 1857, 1701081711)
  val () = _w4(arr, alen, 1861, 1634872690)
  val () = _w4(arr, alen, 1865, 1937074532)
  val () = _w4(arr, alen, 1869, 2020619322)
  val () = _w4(arr, alen, 1873, 1852794427)
  val () = _w4(arr, alen, 1877, 1769155956)
  val () = _w4(arr, alen, 1881, 825910650)
  val () = _w4(arr, alen, 1885, 997025138)
  val () = _w4(arr, alen, 1889, 1835626081)
  val () = _w4(arr, alen, 1893, 1869182049)
  val () = _w4(arr, alen, 1897, 1970289262)
  val () = _w4(arr, alen, 1901, 543519596)
  val () = _w4(arr, alen, 1905, 1932865073)
  val () = _w4(arr, alen, 1909, 1935762720)
  val () = _w4(arr, alen, 1913, 1852386661)
  val () = _w4(arr, alen, 1917, 1953853229)
  val () = _w4(arr, alen, 1921, 1718511904)
  val () = _w4(arr, alen, 1925, 1953066601)
  val () = _w4(arr, alen, 1929, 1799388517)
  (* @keyframes pulse *)
  val () = _w4(arr, alen, 1933, 1919318373)
  val () = _w4(arr, alen, 1937, 1936026977)
  val () = _w4(arr, alen, 1941, 1819635744)
  val () = _w4(arr, alen, 1945, 813393267)
  val () = _w4(arr, alen, 1949, 808528933)
  val () = _w4(arr, alen, 1953, 1870341424)
  val () = _w4(arr, alen, 1957, 1768120688)
  val () = _w4(arr, alen, 1961, 825915764)
  val () = _w4(arr, alen, 1965, 623916413)
  val () = _w4(arr, alen, 1969, 1634758523)
  val () = _w4(arr, alen, 1973, 2037672291)
  val () = _w4(arr, alen, 1977, 2100702778)
  (* .import-status *)
  val () = _w4(arr, alen, 1981, 1835609725)
  val () = _w4(arr, alen, 1985, 1953656688)
  val () = _w4(arr, alen, 1989, 1635021613)
  val () = _w4(arr, alen, 1993, 2071164276)
  val () = _w4(arr, alen, 1997, 1684300144)
  val () = _w4(arr, alen, 2001, 979857001)
  val () = _w4(arr, alen, 2005, 1915822128)
  val () = _w4(arr, alen, 2009, 1664839013)
  val () = _w4(arr, alen, 2013, 1919904879)
  val () = _w4(arr, alen, 2017, 943203130)
  val () = _w4(arr, alen, 2021, 1868970808)
  val () = _w4(arr, alen, 2025, 1932358766)
  val () = _w4(arr, alen, 2029, 979729001)
  val () = _w4(arr, alen, 2033, 1916090414)
  val () = _w4(arr, alen, 2037, 1832611173)
  val () = _w4(arr, alen, 2041, 1747807849)
  val () = _w4(arr, alen, 2045, 1751607653)
  val () = _w4(arr, alen, 2049, 774978164)
